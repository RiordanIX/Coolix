...
inline void	cpu_lw(instruct_t B_reg, instruct_t D_reg, instruct_t Address, instruct_t offset) {
	registers[D_reg] = registers[B_reg];
}

inline void	cpu_movi(instruct_t B_reg, instruct_t D_reg, instruct_t Address, instruct_t offset) {
	registers[D_reg] = Address;
}
inline void	cpu_addi(instruct_t B_reg, instruct_t D_reg, instruct_t Address, instruct_t offset) {
	if (B_reg == 0) {
		registers[D_reg] += Address;
	}
}

inline void	cpu_muli(instruct_t B_reg, instruct_t D_reg, instruct_t Address, instruct_t offset) {
	if (B_reg == 0) {
		registers[D_reg] *= Address;
	}
}

inline void	cpu_divi(instruct_t B_reg, instruct_t D_reg, instruct_t Address, instruct_t offset) {
	registers[D_reg] /= Address;
}

inline void	cpu_ldi(instruct_t B_reg, instruct_t D_reg, instruct_t Address, instruct_t offset) {
	registers[D_reg] = Address;
}
